...
Return<uint32_t> FingerprintAuthenticator::verifyUser(const sp<IVerifyUserCallback>& callback,
                                                      const hidl_vec<uint8_t>& fido_auth_input_1,
                                                      const hidl_vec<uint8_t>& fido_auth_input_2,
    ...
    if (mDevice) {
        status = mDevice->verify_user(mDevice,
                                      fido_auth_input_1.data(),
                                      fido_auth_input_1.size(),
                                      fido_auth_input_2.data(),
                                      fido_auth_input_2.size(),
