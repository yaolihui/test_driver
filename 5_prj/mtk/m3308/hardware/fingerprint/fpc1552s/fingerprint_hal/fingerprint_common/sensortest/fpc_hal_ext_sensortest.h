...
typedef enum {
    ...
    FPC_HAL_EXT_SENSORTEST_INIT,
    FPC_HAL_EXT_SENSORTEST_EXIT,
    FPC_HAL_EXT_SENSORTEST_DP,
    FPC_HAL_EXT_SENSORTEST_FD,
    FPC_HAL_EXT_SENSORTEST_INT,
    FPC_HAL_EXT_SENSORTEST_SPI,
    FPC_HAL_EXT_SENSORTEST_SELF,
