...
struct fpc_engineering {
    void (*get_sensor_size)(fpc_engineering_t *self, uint16_t *width, uint16_t *height);
    ...
    void (*set_cancel_image_injection)(fpc_engineering_t *self);
    void (*clear_cancel_image_injection)(fpc_engineering_t *self);
    ...
    int (*get_build_info)(fpc_engineering_t *self,
