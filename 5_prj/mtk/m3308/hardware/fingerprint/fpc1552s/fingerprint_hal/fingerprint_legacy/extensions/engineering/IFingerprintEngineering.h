...
public:
    ...
    virtual void getSensorSize(uint16_t *width, uint16_t *height) = 0;
    virtual void startImageSubscription(const sp<IImageSubscriptionCallback> &callback) = 0;
    virtual void stopImageSubscription() = 0;
    virtual void startImageInjection(const sp<IImageInjectionCallback> &callback) = 0;
    virtual void stopImageInjection() = 0;
    virtual void startCapture(const sp<ICaptureCallback> &callback, fpc_capture_mode_t mode) = 0;
