...
class FingerprintSensorTest : public BnFingerprintSensorTest, public IBinder::DeathRecipient
{
public:
    ...
    virtual void getSensorTests(fpc_hal_ext_sensortest_tests_t *sensorTests);
    ...
    virtual void capture(const sp<ISensorTestCaptureCallback> &callback, bool waitForFinger,
                         bool uncalibrated);
