...
public class Logger {
    ...
    private static final String TAG = "FpcSensorTestTool";
    ...
    /**
     * Formats a log string using a known locale.
     *
     * @param formatString  A printf-styled formatting string.
     * @param args  Optional arguments referenced in the format string.
     *
     * @return  The formatted string.
     */
    @NonNull
    public static String format(@NonNull String formatString, Object... args) {
        try {
            return String.format(Locale.US, formatString, args);

        } catch (IllegalFormatException e) {
            return formatString + " : " + e.getMessage();
        }
    }
}
