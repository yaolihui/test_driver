...
PARAM_UPD_ITEM(param, 2, SysParam, SLAlg, NULL, C_AlgParmOpt,  pb.param[CFG_PB_PARAM_OPT_PARMC],       TYPE_INT32_ARRAY)
PARAM_UPD_ITEM(param, 2, SysParam, SLAlg, NULL, C_AlgParmFd,   pb.param[CFG_PB_PARAM_OPT_FD],          TYPE_INT32_ARRAY)
PARAM_UPD_ITEM(param, 2, SysParam, SLAlg, NULL, C_CustParm,    pb.param[CFG_PB_PARAM_CUST],            TYPE_INT32_ARRAY)
...
PARAM_UPD_ITEM(param, 2, SysParam, SLAlg, NULL, nav_base_frame_num,    mmi.postprocess_ctl.raw[1], TYPE_UINT32)
...
PARAM_UPD_ITEM(param, 2, SysParam, SLAlg, NULL, postprocess_ctl,       mmi.postprocess_ctl.raw[0], TYPE_UINT32)
PARAM_UPD_ITEM(param, 2, SysParam, SLAlg, NULL, postprocess_ctl2,      mmi.postprocess_ctl.raw[1], TYPE_UINT32)
PARAM_UPD_ITEM(param, 2, SysParam, SLAlg, NULL, postprocess_ctl3,      mmi.postprocess_ctl.raw[2], TYPE_UINT32)
PARAM_UPD_ITEM(param, 2, SysParam, SLAlg, NULL, postprocess_ctl4,      mmi.postprocess_ctl.raw[3], TYPE_UINT32)
...
PARAM_UPD_ITEM(param, 2, SysParam, SLAlg, NULL, enroll_post_mask,                   ci.enroll_post_mask,            TYPE_UINT32)
PARAM_UPD_ITEM(param, 2, SysParam, SLAlg, NULL, enroll_post_num,                    ci.enroll_post_num,             TYPE_UINT8)
...
PARAM_UPD_ITEM(param, 2, SysParam, SLAlg, NULL, miscellaneous_ctl,                  ci.misc_ctl.raw[0],             TYPE_UINT32)
PARAM_UPD_ITEM(param, 2, SysParam, SLAlg, NULL, miscellaneous_ctl2,                 ci.misc_ctl.raw[1],             TYPE_UINT32)
PARAM_UPD_ITEM(param, 2, SysParam, SLAlg, NULL, miscellaneous_ctl3,                 ci.misc_ctl.raw[2],             TYPE_UINT32)
PARAM_UPD_ITEM(param, 2, SysParam, SLAlg, NULL, miscellaneous_ctl4,                 ci.misc_ctl.raw[3],             TYPE_UINT32)
...
PARAM_UPD_ITEM(param, 2, SysParam, SLAlg, NULL, frm_loop_max,                       ci.frm_loop_max,                TYPE_UINT8)

PARAM_UPD_ID_FROM(param, 2, SysParam, SLAlg, aec, 0x27) /* aec: 0x27000000 */
PARAM_UPD_ITEM(param, 2, SysParam, SLAlg, NULL, shutterleft,                   aec.aec_left,                TYPE_UINT32)
PARAM_UPD_ITEM(param, 2, SysParam, SLAlg, NULL, shutterright,                  aec.aec_right,               TYPE_UINT32)
PARAM_UPD_ITEM(param, 2, SysParam, SLAlg, NULL, partition_reg,                 aec.partition_reg,           TYPE_UINT32)
PARAM_UPD_ITEM(param, 2, SysParam, SLAlg, NULL, partition_val,                 aec.partition_val,           TYPE_UINT32)
PARAM_UPD_ITEM(param, 2, SysParam, SLAlg, NULL, aec_sram_time,                 aec.aec_time,                TYPE_UINT8)
PARAM_UPD_ITEM(param, 2, SysParam, SLAlg, NULL, aec_ratio,                     aec.aec_ratio,               TYPE_UINT8)
PARAM_UPD_ITEM(param, 2, SysParam, SLAlg, NULL, aec_gap,                       aec.aec_gap,                 TYPE_UINT8)
...
PARAM_UPD_ITEM(param, 2, SysParam, SLAlg, NULL, algorithm_ctl,                 pp.alg_ctl,                 TYPE_UINT32)
...
PARAM_UPD_ITEM(param, 2, SysParam, SLAlg, NULL, cal_maxlooptime,   ft.cal_max_loop,        TYPE_UINT8)
PARAM_UPD_ITEM(param, 2, SysParam, SLAlg, NULL, reliability_score, ft.reliability_score,   TYPE_UINT8)
PARAM_UPD_ITEM(param, 2, SysParam, SLAlg, NULL, big_blot_threshold, ft.big_blot_thr,       TYPE_UINT16)

PARAM_UPD_ITEM(param, 2, SysParam, SLAlg, NULL, pvalue_gray_threshold,             ft.check_p.p_gray_thr,          TYPE_UINT8)
PARAM_UPD_ITEM(param, 2, SysParam, SLAlg, NULL, pvalue_white_black_threshold,      ft.check_p.p_w_b_thr,           TYPE_UINT8)
PARAM_UPD_ITEM(param, 2, SysParam, SLAlg, NULL, pvalue_gray_area_threshold,        ft.check_p.p_gray_area_thr,     TYPE_INT16)
PARAM_UPD_ITEM(param, 2, SysParam, SLAlg, NULL, pvalue_white_black_area_threshold, ft.check_p.p_w_b_area_thr,      TYPE_INT16)

PARAM_UPD_ITEM(param, 2, SysParam, SLAlg, NULL, bias_threshold,        ft.check_bias.bias_thr,            TYPE_INT16)
PARAM_UPD_ITEM(param, 2, SysParam, SLAlg, NULL, bias_error_threshold,  ft.check_bias.bias_err_thr,        TYPE_INT16)
PARAM_UPD_ITEM(param, 2, SysParam, SLAlg, NULL, center_bias_threshold, ft.check_bias.center_bias_thr,     TYPE_INT32)

PARAM_UPD_ITEM(param, 2, SysParam, SLAlg, NULL, whiteBaseWhiteThr,     ft.base_thr.white_base_white_thr,   TYPE_UINT8)
PARAM_UPD_ITEM(param, 2, SysParam, SLAlg, NULL, cen_w_start,           ft.base_thr.white_base_white_thr,   TYPE_UINT8)
PARAM_UPD_ITEM(param, 2, SysParam, SLAlg, NULL, whiteBaseBlackThr,     ft.base_thr.white_base_black_thr,   TYPE_UINT8)
PARAM_UPD_ITEM(param, 2, SysParam, SLAlg, NULL, cen_h_start,           ft.base_thr.white_base_black_thr,   TYPE_UINT8)
PARAM_UPD_ITEM(param, 2, SysParam, SLAlg, NULL, blackBaseWhiteThr,     ft.base_thr.black_base_white_thr,   TYPE_UINT8)
PARAM_UPD_ITEM(param, 2, SysParam, SLAlg, NULL, cen_w_ace,             ft.base_thr.black_base_white_thr,   TYPE_UINT8)
PARAM_UPD_ITEM(param, 2, SysParam, SLAlg, NULL, blackBaseBlackThr,     ft.base_thr.black_base_black_thr,   TYPE_UINT8)
PARAM_UPD_ITEM(param, 2, SysParam, SLAlg, NULL, cen_h_ace,             ft.base_thr.black_base_black_thr,   TYPE_UINT8)
PARAM_UPD_ITEM(param, 2, SysParam, SLAlg, NULL, middleBaseWhiteThr,    ft.base_thr.middle_base_white_thr,  TYPE_UINT8)
PARAM_UPD_ITEM(param, 2, SysParam, SLAlg, NULL, middleBaseBlackThr,    ft.base_thr.middle_base_black_thr,  TYPE_UINT8)
PARAM_UPD_ITEM(param, 2, SysParam, SLAlg, NULL, diffBaseMinThr,        ft.base_thr.diff_base_min_thr,      TYPE_UINT8)
PARAM_UPD_ITEM(param, 2, SysParam, SLAlg, NULL, diffBaseMaxThr,        ft.base_thr.diff_base_max_thr,      TYPE_UINT8)

PARAM_UPD_ITEM(param, 2, SysParam, SLAlg, NULL, mask_min1,             ft.mask.mask_min1,         TYPE_INT16)
PARAM_UPD_ITEM(param, 2, SysParam, SLAlg, NULL, mask_min2,             ft.mask.mask_min2,         TYPE_INT16)
PARAM_UPD_ITEM(param, 2, SysParam, SLAlg, NULL, mask_min3,             ft.mask.mask_min3,         TYPE_INT16)
PARAM_UPD_ITEM(param, 2, SysParam, SLAlg, NULL, mask_max1,             ft.mask.mask_max1,         TYPE_INT16)
PARAM_UPD_ITEM(param, 2, SysParam, SLAlg, NULL, mask_max2,             ft.mask.mask_max2,         TYPE_INT16)
PARAM_UPD_ITEM(param, 2, SysParam, SLAlg, NULL, mask_max3,             ft.mask.mask_max3,         TYPE_INT16)
PARAM_UPD_ITEM(param, 2, SysParam, SLAlg, NULL, mask_threshold,        ft.mask.mask_thr,          TYPE_INT16)
PARAM_UPD_ITEM(param, 2, SysParam, SLAlg, NULL, mask_error_threshold,  ft.mask.mask_err_thr,      TYPE_INT16)
PARAM_UPD_ITEM(param, 2, SysParam, SLAlg, NULL, mask_ex_threshold,     ft.mask.mask_ex,           TYPE_INT16)
...
PARAM_UPD_ITEM(param, 2, SysParam, SLAlg, NULL, snr_img_num,            ft.check_snr.snr_img_num,       TYPE_UINT8)
PARAM_UPD_ITEM(param, 2, SysParam, SLAlg, NULL, snr_cut,                ft.check_snr.snr_cut,           TYPE_UINT32)
PARAM_UPD_ITEM(param, 2, SysParam, SLAlg, NULL, snrThr,                 ft.check_snr.snr_thr,           TYPE_UINT16)
PARAM_UPD_ITEM(param, 2, SysParam, SLAlg, NULL, signalThr,              ft.check_snr.signal_thr,        TYPE_UINT16)
...
PARAM_UPD_ITEM(param, 1, op_registers, NULL, NULL, esd_irq_mask,       esd.irq_mask,   TYPE_UINT32)
PARAM_UPD_ITEM(param, 1, op_registers, NULL, NULL, data_int_reg,       esd.int_reg[0], TYPE_UINT32)
PARAM_UPD_ITEM(param, 1, op_registers, NULL, NULL, data_int_val,       esd.int_val[0], TYPE_UINT32)
PARAM_UPD_ITEM(param, 1, op_registers, NULL, NULL, data_int_reg2,      esd.int_reg[1], TYPE_UINT32)
PARAM_UPD_ITEM(param, 1, op_registers, NULL, NULL, data_int_val2,      esd.int_val[1], TYPE_UINT32)
PARAM_UPD_ITEM(param, 1, op_registers, NULL, NULL, data_int_reg3,      esd.int_reg[2], TYPE_UINT32)
PARAM_UPD_ITEM(param, 1, op_registers, NULL, NULL, data_int_val3,      esd.int_val[2], TYPE_UINT32)
...
PARAM_UPD_ID_FROM(param, 1, op_registers, NULL, vddio, 0x49)
PARAM_UPD_ITEM_EXT(param, 1, op_registers, NULL, NULL, vddio_reg,       ext_v5.vddio_reg,       TYPE_UINT32,        301)
PARAM_UPD_ITEM_EXT(param, 1, op_registers, NULL, NULL, vddio_val,       ext_v5.vddio_val,       TYPE_UINT32,        301)
PARAM_UPD_ITEM_EXT(param, 1, op_registers, NULL, NULL, vddio_mask,      ext_v5.vddio_mask,      TYPE_UINT32,        302)
PARAM_UPD_ITEM_EXT(param, 1, op_registers, NULL, NULL, ocp_trig_reg,    ext_v5.ocp_trig_reg,    TYPE_UINT32,        302)
PARAM_UPD_ITEM_EXT(param, 1, op_registers, NULL, NULL, ocp_trig_val,    ext_v5.ocp_trig_val,    TYPE_UINT32,        302)

PARAM_UPD_ID_FROM(param, 1, op_registers, NULL, trim, 0x50)
PARAM_UPD_ITEM_EXT(param, 1, op_registers, NULL, NULL, trim_otp_reg1,       ext_v5.trim1.otp_reg,   TYPE_UINT32,    302)
PARAM_UPD_ITEM_EXT(param, 1, op_registers, NULL, NULL, trim_reg1,           ext_v5.trim1.trim_reg,  TYPE_UINT32,    302)
PARAM_UPD_ITEM_EXT(param, 1, op_registers, NULL, NULL, trim_otp_mask1,      ext_v5.trim1.otp_mask,  TYPE_INT16,     302)
PARAM_UPD_ITEM_EXT(param, 1, op_registers, NULL, NULL, trim_offset1,        ext_v5.trim1.offset,    TYPE_INT8,      302)