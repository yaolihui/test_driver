...
int32_t silfp_impl_auth_step(uint64_t op_id, uint32_t step, uint32_t is_pay, uint32_t *fid, uint32_t *flag);
int32_t silfp_impl_auth_end(void);
int32_t silfp_impl_get_auth_tpl_upd(void);
...
int32_t silfp_impl_otp_parse(void __unused *buf, uint32_t __unused size, uint32_t __unused offset, uint32_t __unused *otp, uint32_t __unused count);
