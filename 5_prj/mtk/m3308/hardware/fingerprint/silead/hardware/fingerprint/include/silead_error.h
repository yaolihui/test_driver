...
typedef enum sl_error {
    ...
    SL_ERROR_BLACK_BASE_EXPOSURE_FAILED,    /* 1067 ERR: check black_base_exposure failed */
    SL_ERROR_RELIABILITY_TEST_FAILED,       /* 1068 ERR: reliability test failed */
    SL_ERROR_DETECTED_MIS_TOUCH,            /* 1069 ERR: detected mis-touch */
    SL_ERROR_CALIBRATE_DATA_INVALID,        /* 1070 ERR: Calibrate data is invalid */

    SL_ERROR_SESSION_INVALID,               /* 1071 ERR: Session is invalid */
    SL_ERROR_IMG_CHECK_FAILED,              /* 1072 ERR: image check failed */
    SL_ERROR_IMG_CHECK_ARTIFICIAL,          /* 1073 ERR: image check artificial failed */
    SL_ERROR_IMG_CHECK_MEMBRANE,            /* 1074 ERR: image check membrane failed */
    SL_ERROR_IMG_CHECK_SHADOW,              /* 1075 ERR: image check shadow failed */
    SL_ERROR_IMG_CHECK_RELATIVE,            /* 1076 ERR: image check relative failed */
    SL_ERROR_IMG_CHECK_CENTER_MEAN,         /* 1077 ERR: image check center mean failed */
    SL_ERROR_IMG_CHECK_SPOOF,               /* 1078 ERR: image check spoof failed */
    SL_ERROR_IMG_CHECK_ICON,                /* 1079 ERR: image check icon failed */
    SL_ERROR_IMG_CHECK_MISTOUCH,            /* 1080 ERR: image check mistouch */

    SL_ERROR_TEST_TEMPER_RISE_FAILED,       /* 1081 ERR: test Temperature rise fail*/
    SL_ERROR_MAX,                           /* max */
} sl_error_t;
...
static inline const char *silfp_err_to_string(int32_t err)
{
    static const err_desc_t desc[] = {
        ...
        {"BLACK_BASE_EXPOSURE_FAILED"} ,     /* 1067 */
        {"RELIABILITY_TEST_FAILED"},         /* 1068 */
        {"DETECTED_MIS_TOUCH"},              /* 1069 */
        {"CALIBRATE_DATA_INVALID"},          /* 1070 */

        {"SESSION_INVALID"},                 /* 1071 */
        {"IMG_CHECK_FAILED"},                /* 1072 */
        {"IMG_CHECK_ARTIFICIAL"},            /* 1073 */
        {"IMG_CHECK_MEMBRANE"},              /* 1074 */
        {"IMG_CHECK_SHADOW"},                /* 1075 */
        {"IMG_CHECK_RELATIVE"},              /* 1076 */
        {"IMG_CHECK_CENTER_MEAN"},           /* 1077 */
        {"IMG_CHECK_SPOOF"},                 /* 1078 */
        {"IMG_CHECK_ICON"},                  /* 1079 */
        {"IMG_CHECK_MISTOUCH"},              /* 1080 */
        {"TEMPER_RISE_FAILED"},              /* 1081 */
    };
