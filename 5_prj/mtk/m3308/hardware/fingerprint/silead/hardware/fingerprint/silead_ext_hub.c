...
static pthread_mutex_t m_startup_mutex = PTHREAD_MUTEX_INITIALIZER;
static pthread_cond_t m_startup_cond = PTHREAD_COND_INITIALIZER;
// eventloop end
//=====================================================================
...
static pthread_mutex_t m_write_mutex = PTHREAD_MUTEX_INITIALIZER;
// sockets end
//=====================================================================
