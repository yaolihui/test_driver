...
static int32_t m_key_mode_enable = 1;
...
static int32_t _nav_is_multi_type(void)
{
    return ((m_nav_type == NAV_TYPE_DIR_UPDOWN_MULTI) || (m_nav_type == NAV_TYPE_DIR_LR_MULTI));
}
...
{
    LOG_MSG_DEBUG("(%d --> %d)", m_key_mode_enable, enable);
