...
public class FactoryTestConst {
    ...
    public static final boolean FP_UI_OPTIC_MODE_DEFAULT = false;
    ...
    public static final String OPTIC_SETTINGS_FINGER_IMAGE_X_NAME = "layout_x";
    ...
    public static final int OPTIC_SETTINGS_FINGER_IMAGE_X_DEFAULT = -1;
