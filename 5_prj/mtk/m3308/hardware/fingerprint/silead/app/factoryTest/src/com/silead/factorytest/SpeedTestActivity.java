...
public class SpeedTestActivity extends Activity implements View.OnClickListener {
    ...
    public void onCreate(Bundle icicle) {
        ...
        mFingerprintImageYCenter = SharedPreferencesData.loadDataInt(sharecontext, FactoryTestConst.OPTIC_SETTINGS_CONFIG,
                FactoryTestConst.OPTIC_SETTINGS_FINGER_IMAGE_Y_NAME, FactoryTestConst.OPTIC_SETTINGS_FINGER_IMAGE_Y_DEFAULT);
        mFingerprintImageXCenter = SharedPreferencesData.loadDataInt(sharecontext, FactoryTestConst.OPTIC_SETTINGS_CONFIG,
                FactoryTestConst.OPTIC_SETTINGS_FINGER_IMAGE_X_NAME, FactoryTestConst.OPTIC_SETTINGS_FINGER_IMAGE_X_DEFAULT);
        if (mFingerprintImageXCenter == FactoryTestConst.OPTIC_SETTINGS_FINGER_IMAGE_X_DEFAULT) {
    ...
    private void initIcon() {
        ...
        lp.y = mFingerprintImageYCenter - mFingerprintImageHeight / 2;
        lp.x = mFingerprintImageXCenter - mFingerprintImageWidth / 2;
